    ...
    return (
        <Section id="how-to-use">
            <div className='container '>
                <Heading title="Generative Ai made for Creators" text="BrainWave unlocks the potential Ai-powered Applications" />
                <div className='relative'>
                    <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] '>
                        <div className='absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto ' >
                            <img className='w-full h-full object-cover md:object-right' width={800} height={730} src={service1} alt="" />
                        </div>
                        <div className='relative z-1 max-w-[17rem] ml-auto '>
                            <h4 className='h4 mb-4 '>Smartest AI</h4>
                            <p className='body-2 mb-[3rem] text-n-3 '>
                                BrainWave unlocks the potential Ai-powered Applications
                            </p>
                            <ul className='body-2'>
                                {brainwaveServices.map((item, index) => (
                                    <li className='flex items-start py-4 border-t border-n-6 gap-5' key={index}>
